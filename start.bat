...
if defined NODE_FOUND (
    ...
    echo y | npx @playwright/mcp install-browser chromium >nul 2>&1
    if errorlevel 1 (
        echo [WARN] Playwright Chromium のインストールに失敗しました。手動実行: npx @playwright/mcp install-browser chromium
    ) else (
